    ...
    background-position: center;
            ...
            >
              <div class="mkdf-title-image">
                <img
                  itemprop="image"
                  src="../wp-content/uploads/2019/10/blog-post-img-09.jpg"
                  alt="s"
                />
              </div>
              <div
            ...
            <div class="mkdf-container" style="padding-top:3rem">
              <div class="mkdf-container-inner clearfix">
                <div
                  class="mkdf-grid-row mkdf-content-has-sidebar mkdf-grid-large-gutter"
                >
                @if(isset($content))
                    {!! $content->content !!}
                @endif
