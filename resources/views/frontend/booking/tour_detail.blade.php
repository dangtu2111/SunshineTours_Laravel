                ...
                <div class="container">
                    <div class="main-cn detail-page bg-white clearfix">
                                ...
                                <div class="col-lg-9 tour-meals-cn">
                                    <div class="tour-detail-text">
                                        <ul class="tour-meals-gallery">
                                            <li><img src="{{asset('frontend/images/img-1.jpg')}}" alt=""></li>
                                            <li><img src="{{asset('frontend/images/img-2_1.jpg')}}" alt=""></li>
                                            <li><img src="{{asset('frontend/images/img-3_1.jpg')}}" alt=""></li>
                                            <li><img src="{{asset('frontend/images/img-4_1.jpg')}}" alt=""></li>
                                            <li><img src="{{asset('frontend/images/img-5_1.jpg')}}" alt=""></li>
                                        </ul>
                                        <p>
                        ...
                        <section class="tour-necessary detail-cn" id="tour-necessary">
                            <div class="row">
                                <div class="col-lg-3 detail-sidebar">
                                    <div class="scroll-heading" style="position: fixed; top: 82px;">
