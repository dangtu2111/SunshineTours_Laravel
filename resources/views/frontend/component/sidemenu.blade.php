<section class="mkdf-side-menu">
		...
		<div class="mkdf-side-menu-wrapper">
			<div id="custom_html-4" class="widget_text widget mkdf-sidearea widget_custom_html">
				<div class="textwidget custom-html-widget"><a href="index.html"> <img
							src="{{asset('frontend/wp-content/uploads/2019/10/logo-dark-img-01.png')}}" alt="alt"
			...
			<div id="text-8" class="widget mkdf-sidearea widget_text">
				<div class="textwidget">
					<p style="font-size: 18px; line-height: 26px; color: #878787;">Lorem ipsum dolor sit amet,
    ...
    <div class="rbt-toolbar" data-theme="Wanderland" data-featured="" data-button-position="30%"
